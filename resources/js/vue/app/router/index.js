...
const routes = [
...

  {
    ...
    name: 'MainPage',
    component: () => import(/* webpackChunkName: "MainPage" */ '@/pages/admin/Main/index.vue'),
  },
//   {
...
//     component: () => import(/* webpackChunkName: "PersonalPolicyPage" */ '@/pages/PersonalPolicyPage/PersonalPolicyPage.vue')
//   },
//   {
