<div class="admin-aside">
    <a class="admin-aside-top" href="{{ route('admin.index') }}">Logo</a>
    <nav class="admin-aside__nav">
        <a class="admin-aside__link" href="">
            <svg fill="#000000" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 28.145 28.145">
        ...
        <a class="admin-aside__link" href="{{ route('admin.posts.index') }}">
